...
const SurveyFormReview = ({ onCancel, formValues, submitSurvey, history }) => {
    ...
    return (
        <div className="container">
            ...
            <button type="submit" onClick={() => submitSurvey(formValues, history)} className="teal btn-flat right white-text waves-effect">Send Survey<i className="material-icons right">email</i></button>
        </div>
    );
}
